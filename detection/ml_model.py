    ...
    def load_models(self):
        try:
            if os.path.exists(RF_MODEL_PATH):
                ...
                logger.warning(f"[MODEL] RandomForest not found at {RF_MODEL_PATH}")
        ...
        try:
            if os.path.exists(XGB_MODEL_PATH):
                ...
                logger.warning(f"[MODEL] XGBoost not found at {XGB_MODEL_PATH}")
        ...
        try:
            if os.path.exists(LABEL_ENCODER_PATH):
                ...
                logger.warning(
                    f"[MODEL] LabelEncoder not found at {LABEL_ENCODER_PATH}"
                )
